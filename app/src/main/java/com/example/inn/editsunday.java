...
public class editsunday extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_editsunday);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                databaseReference.child("Sunday").setValue(food);

                Toast.makeText(editsunday.this,"Updated Successfully",Toast.LENGTH_LONG).show();

                Intent intent=new Intent(editsunday.this,edittimetable.class);
