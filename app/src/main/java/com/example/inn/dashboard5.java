...
public class dashboard5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        calender.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(dashboard5.this,calender.class);
        ...
        mess.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(dashboard5.this,MessTimeTable.class);
                startActivity(intent);
        ...
        studentyear.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(dashboard5.this,Students.class);
                startActivity(intent);
            }
        });
        ...
        myprofile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent=new Intent(dashboard5.this,profile5.class);
                startActivity(intent);
        ...
        Logout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent=new Intent(dashboard5.this,MainActivity.class);
                finish();
                startActivity(intent);
            }
        });
        ...
        fees.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(dashboard5.this,fee4.class);
                startActivity(intent);
            }
        });
        ...
        facility.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(dashboard5.this,Facility.class);
                startActivity(intent);
            }
        });
    }
