...
public class editsaturday extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_editsaturday);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                databaseReference.child("Saturday").setValue(food);

                Toast.makeText(editsaturday.this,"Updated Successfully",Toast.LENGTH_LONG).show();

                Intent intent=new Intent(editsaturday.this,edittimetable.class);
