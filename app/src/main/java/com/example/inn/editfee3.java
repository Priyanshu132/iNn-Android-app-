...
public class editfee3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                databaseReference.child("Manpreet_dhillon").setValue(studentsName);        // for adding new students


                Toast.makeText(editfee3.this,"data inserted successfully",Toast.LENGTH_LONG).show();

                Intent intent=new Intent(editfee3.this,editshow2.class);
