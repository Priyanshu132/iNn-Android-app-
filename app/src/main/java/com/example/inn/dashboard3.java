    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        calender.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(dashboard3.this,calender.class);
        ...
        mess.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(dashboard3.this,MessTimeTable.class);
                startActivity(intent);
        ...
        studentyear.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(dashboard3.this,Students.class);
                startActivity(intent);
            }
        });
        ...
        myprofile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent=new Intent(dashboard3.this,profile3.class);
                startActivity(intent);
        ...
        fees.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(dashboard3.this,fee2.class);
                startActivity(intent);
            }
        });
        ...
        facility.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(dashboard3.this,Facility.class);
                startActivity(intent);
            }
        });
    }
