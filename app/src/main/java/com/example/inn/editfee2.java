...
public class editfee2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                databaseReference.child("Aryan_singh").setValue(studentsName);        // for adding new students
                Toast.makeText(editfee2.this,"data inserted successfully",Toast.LENGTH_LONG).show();

                Intent intent=new Intent(editfee2.this,editshow1.class);
