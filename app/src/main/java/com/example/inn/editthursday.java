...
public class editthursday extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_editthursday);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                databaseReference.child("Thursday").setValue(food);

                Toast.makeText(editthursday.this,"Updated Successfully",Toast.LENGTH_LONG).show();

                Intent intent=new Intent(editthursday.this,edittimetable.class);
