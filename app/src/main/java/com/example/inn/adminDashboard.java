...
public class adminDashboard extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mess.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(adminDashboard.this,showupdate.class);
                startActivity(intent);
        ...
        studentyear.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(adminDashboard.this,Students.class);
                startActivity(intent);
            }
        });
        ...
        fees.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(adminDashboard.this,adminPayment.class);
                startActivity(intent);
            }
        });
        ...
        facility.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(adminDashboard.this,Facility.class);
                startActivity(intent);
            }
        });
    }
