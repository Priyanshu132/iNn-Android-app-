...
public class editwednesday extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_editwednesday);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                databaseReference.child("Wednesday").setValue(food);

                Toast.makeText(editwednesday.this,"Updated Successfully",Toast.LENGTH_LONG).show();

                Intent intent=new Intent(editwednesday.this,edittimetable.class);
