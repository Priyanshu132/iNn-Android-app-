...
public class edittuesday extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edittuesday);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                databaseReference.child("Tuesday").setValue(food);

                Toast.makeText(edittuesday.this,"Updated Successfully",Toast.LENGTH_LONG).show();
                Intent intent=new Intent(edittuesday.this,edittimetable.class);
