...
public class editmonday extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_editmonday);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                databaseReference.child("Monday").setValue(food);

                Toast.makeText(editmonday.this,"Updated Successfully",Toast.LENGTH_LONG).show();

                Intent intent=new Intent(editmonday.this,edittimetable.class);
