    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        calender.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(dashboard4.this,calender.class);
        ...
        mess.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(dashboard4.this,MessTimeTable.class);
                startActivity(intent);
        ...
        studentyear.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(dashboard4.this,Students.class);
                startActivity(intent);
            }
        });
        ...
        myprofile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent=new Intent(dashboard4.this,profile4.class);
                startActivity(intent);
        ...
        Logout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent=new Intent(dashboard4.this,MainActivity.class);
                startActivity(intent);
            }
        });
        ...
        fees.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(dashboard4.this,fee3.class);
                startActivity(intent);
            }
        });
        ...
        facility.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(dashboard4.this,Facility.class);
                startActivity(intent);
            }
        });
    }
